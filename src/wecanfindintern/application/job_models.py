"""Application query contracts shared by API, persistence and Agent adapters."""
...
class LocationResponse(BaseModel):
    ...
    region: str | None = Field(
        description="Deprecated compatibility alias of region_code.",
        deprecated=True,
    )
    ...
    country: str | None = Field(
        description="Deprecated compatibility alias of country_code.",
        deprecated=True,
    )
...
class JobDetail(JobListItem):
    schema_version: Literal["job-detail.v4"] = "job-detail.v4"
