...
SKILL_RULES: dict[str, tuple[str, ...]] = {
    ...
    "sql_server": ("sql server", "microsoft sql server"),
    ...
    "transformers": ("transformers library", "transformer models"),
    ...
    "vertex_ai": ("vertex ai", "vertexai"),
    "rag": ("retrieval augmented generation", "retrieval-augmented generation", "rag"),
    "embeddings": ("embeddings", "text embedding"),
    "vector_database": ("vector database", "vector databases", "vector db"),
    "vector_search": ("vector search", "similarity search"),
    "prompt_engineering": ("prompt engineering", "prompt design"),
    "function_calling": ("function calling", "function-calling"),
    "tool_calling": ("tool calling", "tool-calling"),
    "mcp": ("model context protocol", "mcp server", "mcp tool"),
    "fine_tuning": ("fine tuning", "fine-tuning", "finetuning"),
    "rlhf": ("rlhf", "reinforcement learning from human feedback"),
    "lora": ("lora fine tuning", "low rank adaptation"),
    "model_evaluation": ("model evaluation", "llm evaluation", "llm evals"),
    "guardrails": ("guardrails", "ai safety guardrails"),
    "pinecone": ("pinecone",),
    "weaviate": ("weaviate",),
    "milvus": ("milvus",),
    "qdrant": ("qdrant",),
    ...
    # Testing, security, and collaboration tools
    "pytest": ("pytest",),
    "junit": ("junit",),
    "jest": ("jest",),
    "mocha": ("mocha",),
    ...
    "jira": ("jira",),
    "figma": ("figma",),
    "microsoft_office": ("microsoft office", "ms office"),
    "microsoft_365": ("microsoft 365", "office 365", "m365"),
    "microsoft_word": ("microsoft word", "ms word"),
    ...
    "slack": ("slack",),
    "zoom": ("zoom meetings", "zoom video"),
    "notion": ("notion",),
    "confluence": ("confluence",),
    "acrobat": ("adobe acrobat", "acrobat reader"),
